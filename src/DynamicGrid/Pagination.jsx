        ...
        >
          ...
          {Array.from({ length: endPage - startPage }).map((_, idx) => (
            <button
              ...
              className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ${pageIndex === startPage + idx + 1 ? "z-10 primary text-white" : "text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50"}`}
            >
              {startPage + idx + 1}
            </button>
          ))}
